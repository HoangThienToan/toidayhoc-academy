            ...
            <div class="d-flex justify-content-center p-5">
                <div class="mt-5 rounded " style="width: 500px;box-shadow: 0px 40px 80px 0px rgba(2, 2, 26, 0.14);">
                    ...
                    <form id="form" class="card-body p-5" >
                        <div class="keep sigup-input">
                            <h5>Account name</h5>
                            <input type="text" class="form-control" id="Name" placeholder="Account name">
                            <span id="reminderName"></span>
                            <svg xmlns="http://www.w3.org/2000/svg" color="#6c757d" width="20" height="20" fill="currentColor" class="bi bi-person"
                                viewBox="0 0 16 16">
                                <path
                        ...
                        <div class="keep sigup-input">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" color="#6c757d" width="20" height="20" fill="currentColor"
                        ...
                        <div class="d-flex flex-nowrap">
                            <div class="form-group sigup-input keep pb-2 header1 w-50">
                                <h5>Password</h5>
                                <input type="password" class="form-control" id="create" placeholder="Password" required>
                            ...
                            <div class="form-group sigup-input keep pb-2 header1 w-50 px-1">
                                <h5>Re-Password</h5>
                                <input type="password" class="form-control" id="retry" placeholder="Re-Password" required>
                        ...
                        <div class="mb-3 form-check">
                            ...
                            <label class="form-check-label" for="exampleCheck1">I agree to the <a href="#" class="fw-bold">Terms & Conditions</a></label>
                        </div>
                        
                    </form>
                    <div class="p-5">
                            <button class="btn btn-primary submit fw-bold" id="sigup" style="line-height: 40px;">Sigup</button>
                        </div>
                    <div class="pb-3 text-center">
                        <div class="">Already have an account? <a href="sigin.php" class="fw-bold"
                                style="color: #0d88f0;">Sigin</a></div>
                    </div>
                </div>
            </div>
        </div>
